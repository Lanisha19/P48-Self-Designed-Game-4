...
function draw() {
  ...
  if(gameState===1){
    ...
    textSize(20);
    fill("white");
    text("*Click on the treasureHunt logo to hide the snakes and start playing the game", 10, 50);
    text("*you can also use up and left arrow together to go diagonally", 10, 70);
    text(" upLeft, upRight, downLeft, downRight", 15, 90);
  }
  ...
  if(gameState===2){
    ...
    var a = createSprite(132, 325, 20, 420);
    var b = createSprite(590, 325, 20, 420);
    var c = createSprite(357, 555, 420, 20);
    b.visible=false;
    a.visible=false;
    c.visible=false;
